...
<template>
  <section>
    <header class="page-heading"><div><div class="folio"><svg viewBox="0 0 24 24"><use href="#app-icon-alarms" /></svg></div><h1>告警中心</h1><p>对设备规则、环境规则、AI 风险和系统故障告警进行筛选与单向状态流转。</p></div><div class="heading-meta"><div><span>查询结果</span><strong>{{ data.total }} 条</strong></div><div><span>状态顺序</span><strong>确认 → 处理 → 关闭</strong></div></div></header>
    <section class="panel">

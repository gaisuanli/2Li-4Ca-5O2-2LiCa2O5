...
<template>
  <section>
    <header class="page-heading"><div><div class="folio"><svg viewBox="0 0 24 24"><use href="#app-icon-audit" /></svg></div><h1>审计日志</h1><p>记录设备维护、规则修改、风险复核、告警处置和喷淋控制等关键操作，并保留请求追踪编号。</p></div><button class="button button-secondary" @click="load">刷新</button></header>
